        ...
        <p>
            <small>
                {{ $exception->getMessage()
                    ? $exception->getMessage() .
                        ' Pengguna tidak memiliki wewenang menjalankan fungsi ini, atau bisa jadi
                            durasi sesi masuk sudah habis. Cobalah untuk masuk kembali atau minta akses menjalankan fungsi ini ke
                            Personalia Pusat'
                    : 'Pengguna tidak memiliki wewenang menjalankan fungsi ini, atau bisa jadi durasi sesi
