...
<div id="mulai-aplikasi">
    ...
    <div class="kartu">
        ...
        <p>Dengan keahlian, ketekunan, pengalaman serta dedikasi seluruh elemen Perusahaan, maka PT. Kepuh Kencana Arum
            ...
            kapasitas
            produksinya dengan mendirikan pabrik di Bogor pada tahun 1997, Makassar pada tahun 2002, Semarang pada tahun
            2010,
        ...
        <p>
        <p>Hingga saat ini telah berkembang juga merk <b>"VIVO"</b> yang telah banyak beredar sebagai pendukung merk
            utama
            <b>"KENCANA"</b> di berbagai daerah di Nusantara. Kini PT. Kepuh Kencana Arum juga mendapat kepercayaan dari
            PT.
            Krakatau Steel melalui kerjasama produksi untuk produk-produk baja ringan yang menggunakan merk Krakatau
            Steel.
        </p>
    </div>
    ...
    <div class="kartu">
        ...
        <ol>
            <li>Melaksanakan proses yang efektif dan efisien dan berpedoman pada Sistem Manajemen Mutu ISO 9001 dan
                terus
                berusaha melakukan peningkatan yang berkesinambungan di dalam Sistem Manajemen Mutu Perusahaan.</li>
            <li>Memenuhi persyaratan pelanggan dan peraturan perundang-undangan yang berlaku demi tercapainya kepuasan
                dan
    ...
    <div class="kartu">
        ...
        <ol>
            <li><b>Pusat Pemasaran</b> : <a href="https://goo.gl/maps/A2gJWm7A7byQLWCd6" target="_blank"
                    rel="noreferrer noopener">Jln Bubutan 127-135, Bubutan, Bubutan, Surabaya, Jawa Timur 60174.</a>
            </li>
            <li><b>Pusat Administrasi</b> : <a href="https://goo.gl/maps/WHrDZVw46Vw" target="_blank"
                    rel="noreferrer noopener">Jln WR Supratman 53, Purwotengah, Kranggan, Mojokerto, Jawa Timur
                    61311.</a>
            </li>
            <li><b>Pusat Pabrik</b> : <a href="https://goo.gl/maps/yZHPoN5G4iKw3FCH9" target="_blank"
                    rel="noreferrer noopener">Jln Raya Bypass KM 54, Balongmojo, Puri, Mojokerto, Jawa Timur 61363.</a>
            </li>
            <li><b>Pabrik Gunung Gedangan</b> : <a href="https://goo.gl/maps/qsSdaj6imhNqm5oc9" target="_blank"
                    rel="noreferrer noopener">Jln Al Azhar (Depan Pondok Al Azhar), Gunung Gedangan, Magersari,
                    Mojokerto,
                    Jawa Timur 61363.</a></li>
            <li><b>Pabrik Semarang</b> : <a href="https://goo.gl/maps/hjAXTbTbJheGRmG9A" target="_blank"
                    rel="noreferrer noopener">Jln Raya Semarang-Solo KM 25 (Sebelah SPBU Lemah Abang) RT 1 RW 5,
                    Karangjati,
            ...
            <li><b>Pabrik Makassar</b> : <a href="https://goo.gl/maps/Y9YEKm7UhWFWHZPS6" target="_blank"
                    rel="noreferrer noopener">Jln Prof Dr Ir Sutami 88, Bulurokeng, Biringkanaya, Makassar, Sulawesi
                    Selatan
                    90242.</a></li>
