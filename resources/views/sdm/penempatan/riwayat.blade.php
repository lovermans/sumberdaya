...
<div id="sdm_penempatan_status">
    ...
    @isset($tabels)
        <div class="cari-data tcetak">
            <form id="form_sdm_penempatan_status_cari" class="form-xhr kartu" method="GET" action="{{ $urlRangka->current() }}">
                <div class="isian">
                    <label for="sdm_penempatan_status_cariStatusAktifSDM">Pilih Status SDM : </label>
                    <select id="sdm_penempatan_status_cariStatusAktifSDM" class="pil-saja tombol" onchange="if (this.value !== '') lemparXHR(true, null, this.value)">
                        <option value="{{ $urlRangka->route('sdm.penempatan.riwayat', $rekRangka->except('unduh')) }}" @selected($rekRangka->routeIs('sdm.penempatan.riwayat'))>SEMUA RIWAYAT</option>
                        <option value="{{ $urlRangka->route('sdm.penempatan.data-aktif', $rekRangka->except('unduh')) }}" @selected($rekRangka->routeIs('sdm.penempatan.data-aktif'))>AKTIF</option>
                        <option value="{{ $urlRangka->route('sdm.penempatan.data-nonaktif', $rekRangka->except('unduh')) }}" @selected($rekRangka->routeIs('sdm.penempatan.data-nonaktif'))>NON-AKTIF</option>
                        <option value="{{ $urlRangka->route('sdm.penempatan.data-akanhabis', $rekRangka->except('unduh')) }}" @selected($rekRangka->routeIs('sdm.penempatan.data-akanhabis'))>AKAN HABIS</option>
                        <option value="{{ $urlRangka->route('sdm.penempatan.data-kadaluarsa', $rekRangka->except('unduh')) }}" @selected($rekRangka->routeIs('sdm.penempatan.data-kadaluarsa'))>KADALUARSA</option>
                        <option value="{{ $urlRangka->route('sdm.penempatan.data-baru', $rekRangka->except('unduh')) }}" @selected($rekRangka->routeIs('sdm.penempatan.data-baru'))>BELUM DITEMPATKAN</option>
                        <option value="{{ $urlRangka->route('sdm.penempatan.data-batal', $rekRangka->except('unduh')) }}" @selected($rekRangka->routeIs('sdm.penempatan.data-batal'))>BATAL DITEMPATKAN</option>
                        <option value="{{ $urlRangka->route('sdm.penempatan.riwayat-nyata', $rekRangka->except('unduh')) }}" @selected($rekRangka->routeIs('sdm.penempatan.riwayat-nyata'))>MASA KERJA NYATA</option>
                    </select>
                </div>
                <div class="isian gspan-2">
                    <label for="sdm_penempatan_status_cariKataKunci">Kata Kunci</label>
                    <input id="sdm_penempatan_status_cariKataKunci" type="text" name="kata_kunci" value="{{ $rekRangka->kata_kunci }}">
                    <span class="t-bantu">Cari no absen, ktp/passport, nama, posisi, lokasi, kontrak, kategori, keterangan</span>
                </div>                
                ...
                <details class="gspan-4" {{ $rekRangka->anyFilled('urut') ? 'open' : '' }} style="padding:0">
                    ...
                    <div class="kartu form" id="sdm_penempatan_status_urut">
                        <div class="isian" data-indeks="{{ $urutAbsen ? $indexAbsen : 'X' }}">
                            ...
                            <select id="sdm_penempatan_status_urutAbsen" name="urut[]" class="pil-dasar" onchange="getElementById('tombol_cari_status_penempatan').click()">
                        ...
                        <div class="isian" data-indeks="{{ $urutMasuk ? $indexMasuk : 'X' }}">
                            ...
                            <select id="sdm_penempatan_status_urutMasuk" name="urut[]" class="pil-dasar" onchange="getElementById('tombol_cari_status_penempatan').click()">
                                <option selected disabled></option>
                        ...
                        <div class="isian" data-indeks="{{ $urutLahir ? $indexLahir : 'X' }}">
                            ...
                            <select id="sdm_penempatan_status_urutLahir" name="urut[]" class="pil-dasar" onchange="getElementById('tombol_cari_status_penempatan').click()">
                                <option selected disabled></option>
                        ...
                        <div class="isian" data-indeks="{{ $urutKeluar ? $indexKeluar : 'X' }}">
                            ...
                            <select id="sdm_penempatan_status_urutKeluar" name="urut[]" class="pil-dasar" onchange="getElementById('tombol_cari_status_penempatan').click()">
                                <option selected disabled></option>
    ...
    <div class="pintasan tcetak">
        ...
        <a class="isi-xhr" data-rekam="false" href="{{ $urlRangka->route('sdm.penempatan.unggah') }}" data-tujuan="#sdm_penem_riwa_sematan" title="Unggah Data Penempatan SDM">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a class="isi-xhr" href="{{ $urlRangka->route('sdm.penempatan.statistik') }}" data-rekam="false" data-laju="true" data-tujuan="#sdm_penem_riwa_sematan" title="Unduh Statistik Penempatan SDM ">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <use xlink:href="{{ $urlRangka->asset($mixRangka('/ikon.svg')) . '#statistik' }}" xmlns:xlink="http://www.w3.org/1999/xlink"></use>
            </svg>
        </a>
    </div>
