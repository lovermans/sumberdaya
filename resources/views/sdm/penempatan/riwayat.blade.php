...
<div id="sdm_penempatan_status">
    ...
    <div class="cari-data tcetak">
        <form id="form_sdm_penempatan_status_cari" class="form-xhr kartu" data-tujuan="#riwa-penem-sdm_tabels"
        ...
        <div class="trek-data tcetak">
            ...
            <div class="saring-cepat">
                <select id="sdm_penempatan_status_cariStatusAktifSDM" class="pil-saja tombol"
                    ...
                    <option
                        value="{{ $urlRangka->route('sdm.penempatan.riwayat', $rekRangka->merge(['fragment' => 'riwa-penem-sdm_tabels'])->except(['unduh', 'page', 'bph']), false) }}"
                        @selected($rekRangka->routeIs('sdm.penempatan.riwayat'))>SEMUA RIWAYAT</option>

                    <option
                        value="{{ $urlRangka->route('sdm.penempatan.data-aktif', $rekRangka->merge(['fragment' => 'riwa-penem-sdm_tabels'])->except(['unduh', 'page', 'bph']), false) }}"
                        @selected($rekRangka->routeIs('sdm.penempatan.data-aktif'))>AKTIF</option>

                    <option
                        value="{{ $urlRangka->route('sdm.penempatan.data-nonaktif', $rekRangka->merge(['fragment' => 'riwa-penem-sdm_tabels'])->except(['unduh', 'page', 'bph']), false) }}"
                        @selected($rekRangka->routeIs('sdm.penempatan.data-nonaktif'))>NON-AKTIF</option>
                    <option
                        value="{{ $urlRangka->route('sdm.penempatan.data-akanhabis', $rekRangka->merge(['fragment' => 'riwa-penem-sdm_tabels'])->except(['unduh', 'page', 'bph']), false) }}"
                        @selected($rekRangka->routeIs('sdm.penempatan.data-akanhabis'))>AKAN HABIS</option>

                    <option
                        value="{{ $urlRangka->route('sdm.penempatan.data-kadaluarsa', $rekRangka->merge(['fragment' => 'riwa-penem-sdm_tabels'])->except(['unduh', 'page', 'bph']), false) }}"
                        @selected($rekRangka->routeIs('sdm.penempatan.data-kadaluarsa'))>KADALUARSA</option>

                    <option
                        value="{{ $urlRangka->route('sdm.penempatan.data-baru', $rekRangka->merge(['fragment' => 'riwa-penem-sdm_tabels'])->except(['unduh', 'page', 'bph']), false) }}"
                        @selected($rekRangka->routeIs('sdm.penempatan.data-baru'))>BELUM DITEMPATKAN</option>

                    <option
                        value="{{ $urlRangka->route('sdm.penempatan.data-batal', $rekRangka->merge(['fragment' => 'riwa-penem-sdm_tabels'])->except(['unduh', 'page', 'bph']), false) }}"
                        @selected($rekRangka->routeIs('sdm.penempatan.data-batal'))>BATAL DITEMPATKAN</option>

                    <option
                        value="{{ $urlRangka->route('sdm.penempatan.riwayat-nyata', $rekRangka->merge(['fragment' => 'riwa-penem-sdm_tabels'])->except(['unduh', 'page', 'bph']), false) }}"
            ...
            <span class="bph">
                ...
                <select id="sdm_penempatan_status_cariPerHalaman" name="bph" class="pil-saja"
                    form="form_sdm_penempatan_status_cari"
                ...
                <div class="kartu form" id="sdm_penempatan_status_urut">
                    <div class="isian" data-indeks="{{ $urutAbsen ? $indexAbsen : 'X' }}">
                        <label for="sdm_penempatan_status_urutAbsen">{{ $urutAbsen ? $indexAbsen.'. ' : '' }}Urut Nomor
                            Absen</label>
                        <select id="sdm_penempatan_status_urutAbsen" name="urut[]"
                    ...
                    <div class="isian" data-indeks="{{ $urutMasuk ? $indexMasuk : 'X' }}">
                        ...
                        <select id="sdm_penempatan_status_urutMasuk" name="urut[]"
                            form="form_sdm_penempatan_status_cari" class="pil-dasar"
                            onchange="getElementById('tombol_cari_status_penempatan').click()">
                            <option selected disabled></option>
                    ...
                    <div class="isian" data-indeks="{{ $urutLahir ? $indexLahir : 'X' }}">
                        ...
                        <select id="sdm_penempatan_status_urutLahir" name="urut[]"
                            form="form_sdm_penempatan_status_cari" class="pil-dasar"
                            onchange="getElementById('tombol_cari_status_penempatan').click()">
                            <option selected disabled></option>
                    ...
                    <div class="isian" data-indeks="{{ $urutKeluar ? $indexKeluar : 'X' }}">
                        <label for="sdm_penempatan_status_urutKeluar">{{ $urutKeluar ? $indexKeluar.'. ' : '' }}Urut
                            Tanggal Keluar</label>

                        <select id="sdm_penempatan_status_urutKeluar" name="urut[]"
                            form="form_sdm_penempatan_status_cari" class="pil-dasar"
                            onchange="getElementById('tombol_cari_status_penempatan').click()">
                            <option selected disabled></option>
                ...
                <tbody>
                    ...
                    <tr @class(['merah'=> $tabel->sdm_tgl_berhenti, 'oranye' => ($tabel->penempatan_selesai &&
                        $tabel->penempatan_selesai <= $dateRangka->today()->addDay(40)),'biru' =>
                            ...
                            <td>{{ rescue(function () use ($tabels, $nomor) { return ($tabels->firstItem() + $nomor);},
                                $loop->iteration, false) }}</td>
