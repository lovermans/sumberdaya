...
<div id="nilai_unggah">
    <form id="form_nilai_unggah" class="form-xhr kartu" method="POST" data-laju="true" data-tujuan="#nilai_unggah"
        action="{{ $urlRangka->route('sdm.penilaian.unggah', [], false) }}">
        ...
        <div class="gspan-4">
            ...
            <p>Unduh <a class="isi-xhr" href="{{ $urlRangka->route('sdm.penilaian.contoh-unggah', [], false) }}"
                    data-rekam="false" data-tujuan="#nilai_unggah" data-laju="true">contoh</a> excel, isi sesuai
