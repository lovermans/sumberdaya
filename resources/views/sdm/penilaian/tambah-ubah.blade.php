...
<div id="sdm_nilai_tambahUbah">
    <form id="form_sdm_nilai_tambahUbah" class="form-xhr kartu" method="POST" action="{{ $app->url->current() }}">
        ...
        <div class="isian panjang">
            ...
            <select id="nilaisdm_no_absen" name="nilaisdm_no_absen" class="pil-cari" required>
                ...
                @foreach ($sdms as $sdm)
                <option @selected($sdm->sdm_no_absen==$app->request->old('nilaisdm_no_absen',
        ...
        <div class="isian normal">
            ...
            <select id="nilaisdm_tahun" name="nilaisdm_tahun" class="pil-cari" required>
                ...
                <option @selected($tahun==$app->request->old('nilaisdm_tahun',
        ...
        <div class="isian normal">
            ...
            <select id="nilaisdm_periode" name="nilaisdm_periode" class="pil-cari" required>
                ...
                <option @selected($app->request->old('nilaisdm_periode',
        ...
        <div class="isian pendek">
            ...
            <input id="nilaisdm_bobot_hadir" type="number" name="nilaisdm_bobot_hadir"
                value="{{ $app->request->old('nilaisdm_bobot_hadir', $nilai->nilaisdm_bobot_hadir ?? null) }}"
                step="0.0001" max="30">
        ...
        <div class="isian pendek">
            ...
            <input id="nilaisdm_bobot_sikap" type="number" name="nilaisdm_bobot_sikap"
                value="{{ $app->request->old('nilaisdm_bobot_sikap', $nilai->nilaisdm_bobot_sikap ?? null) }}"
                step="0.0001" max="30">
        ...
        <div class="isian pendek">
            ...
            <input id="nilaisdm_bobot_target" type="number" name="nilaisdm_bobot_target"
                value="{{ $app->request->old('nilaisdm_bobot_target', $nilai->nilaisdm_bobot_target ?? null) }}"
                step="0.0001" max="40">
        ...
        <div class="isian gspan-4">
            ...
            <textarea id="nilaisdm_tindak_lanjut" name="nilaisdm_tindak_lanjut"
                rows="3">{{ $app->request->old('nilaisdm_tindak_lanjut', $nilai->nilaisdm_tindak_lanjut ?? null) }}</textarea>
        ...
        <div class="isian gspan-4">
            ...
            <textarea id="nilaisdm_keterangan" name="nilaisdm_keterangan"
                rows="3">{{ $app->request->old('nilaisdm_keterangan', $nilai->nilaisdm_keterangan ?? null) }}</textarea>
        ...
        <div class="isian normal">
            ...
            <span class="t-bantu">Scan PDF formulir penilaian {{
                $app->filesystem->exists('sdm/penilaian/berkas/'. $app->request->old('nilaisdm_no_absen',
                $nilai->nilaisdm_no_absen ??
                null) . ' - ' . $app->request->old('nilaisdm_tahun', $nilai->nilaisdm_tahun ?? null) . ' - ' .
                $app->request->old('nilaisdm_periode', $nilai->nilaisdm_periode ?? null) . '.pdf') ? '(berkas yang
                diunggah
