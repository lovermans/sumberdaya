@isset($sanksis)
    <details class="kartu">
        ...
        <div class="scroll-margin" id="tabel_sanksi_sdm_sematan"></div>

        <div class="kartu" id="tabel_sanksi_sdm">
                        ...
                        @forelse ($sanksis as $no => $sanksi)
                            <tr @class(['biru' => str()->contains($sanksi->langgar_tkontrak, 'OS-')])>
                                ...
                                <td>
                                    ...
                                    <b>Berlaku</b> : {{ strtoupper($app->date->make($sanksi->sanksi_mulai)?->translatedFormat('d F Y')) }} s.d
                                    {{ strtoupper($app->date->make($sanksi->sanksi_selesai)?->translatedFormat('d F Y')) }}<br>
                                ...
                                <td>
                                    ...
                                    <b>Tanggal</b> : {{ strtoupper($app->date->make($sanksi->langgar_tanggal)?->translatedFormat('d F Y')) }}<br>
                                ...
                                <td>
                                    @if ($sanksi->langgar_psdm_uuid)
                                        <div @class(['merah' => $sanksi->langgar_psdm_tgl_berhenti])>
                                            ...
                                            <a class="isi-xhr taut-akun" href="{{ $app->url->route('sdm.akun', ['uuid' => $sanksi->langgar_psdm_uuid]) }}">
                                                <img src="{{ $app->filesystem->exists('sdm/foto-profil/' . $sanksi->langgar_pelapor . '.webp')
                                                    ? $app->url->route('sdm.tautan-foto-profil', [
                                                        'berkas_foto_profil' =>
