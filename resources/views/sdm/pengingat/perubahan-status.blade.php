                    ...
                    <tr @class(['biru'=> $strRangka->contains($status->penempatan_kontrak, 'OS-')])>
                            ...
                            <div class="pil-aksi">
                                ...
                                <div class="aksi">
                                    <a class="isi-xhr" data-rekam="false" data-tujuan="#tabel_status_sematan"
                                        href="{{ $urlRangka->route('sdm.penempatan.lihat', ['uuid' => $status->penempatan_uuid], false) }}"
                                        title="Lihat Data Penempatan">Lihat Penempatan</a>

                                    <a class="isi-xhr" data-rekam="false" data-tujuan="#tabel_status_sematan"
                                        href="{{ $urlRangka->route('sdm.penempatan.ubah', ['uuid' => $status->penempatan_uuid], false) }}"
                        ...
                        <td>
                            <a class="isi-xhr taut-akun"
                                href="{{ $urlRangka->route('sdm.akun', ['uuid' => $status->sdm_uuid], false) }}">
