        ...
        <form id="form_sdm_permintaan_tambah_cari" class="form-xhr kartu" data-tujuan="#tambah_sdm_tabels"
            ...
            <details class="gspan-4" {{ $rekRangka->anyFilled(['tgl_diusulkan_mulai', 'tambahsdm_status',
                ...
                <div class="kartu form">
                    ...
                    <button id="tombol_saring_permintaan_sdm" class="utama pelengkap" type="submit" title="Saring Data">
                        <svg viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <use xlink:href="{{ $urlRangka->asset($mixRangka('/ikon.svg')) . '#cari' }}"
                                xmlns:xlink="http://www.w3.org/1999/xlink"></use>
                        </svg> Saring
    ...
    <div id="tambah_sdm_tabels" class="kartu scroll-margin">
        ...
        <div class="trek-data tcetak">
            <span class="bph">
                ...
                <select id="sdm_permintaan_tambah_cariPerHalaman" name="bph" class="pil-saja"
                    form="form_sdm_permintaan_tambah_cari"
            ...
            <span class="trek">
                ...
                <a class="isi-xhr" data-tujuan="#tambah_sdm_tabels" data-frag="true" href="{{ $tabels->url(1) }}"
                    title="Awal">
                    <svg viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="isi-xhr" data-tujuan="#tambah_sdm_tabels" data-frag="true"
                ...
                <a class="isi-xhr" data-tujuan="#tambah_sdm_tabels" data-frag="true" href="{{ $tabels->nextPageUrl() }}"
                    title="Berikutnya">
                    <svg viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <details class="gspan-4" {{ $rekRangka->anyFilled('urut') ? 'open' : '' }}>
                ...
                <div class="kartu form" id="sdm_permintaan_tambah_cariUrut">
                    <div class="isian" data-indeks="{{ $urutNomor ? $indexNomor : 'X' }}">
                        ...
                        <select id="sdm_permintaan_tambah_cariUrutNomor" name="urut[]"
                    ...
                    <div class="isian" data-indeks="{{ $urutJumlah ? $indexJumlah : 'X' }}">
                        ...
                        <select id="sdm_permintaan_tambah_cariUrutJumlah" name="urut[]"
                            form="form_sdm_permintaan_tambah_cari" class="pil-dasar"
                            onchange="getElementById('tombol_cari_permintaan_sdm').click()">
                            <option selected disabled></option>
                    ...
                    <div class="isian" data-indeks="{{ $urutPosisi ? $indexPosisi : 'X' }}">
                        ...
                        <select id="sdm_permintaan_tambah_cariUrutPosisi" name="urut[]"
                            form="form_sdm_permintaan_tambah_cari" class="pil-dasar"
                            onchange="getElementById('tombol_cari_permintaan_sdm').click()">
                            <option selected disabled></option>
                    ...
                    <div class="isian" data-indeks="{{ $urutPenempatan ? $indexPenempatan : 'X' }}">
                        <label for="sdm_permintaan_tambah_cariUrutPenempatan">{{ $urutPenempatan ? $indexPenempatan.'. '
                            : '' }}Urut Penempatan SDM</label>

                        <select id="sdm_permintaan_tambah_cariUrutPenempatan" name="urut[]"
                            form="form_sdm_permintaan_tambah_cari" class="pil-dasar"
                            onchange="getElementById('tombol_cari_permintaan_sdm').click()">
                            <option selected disabled></option>
        ...
        <div class="data ringkas">
            <table id="permintaan-sdm_tabel" class="tabel">
                ...
                <tbody>
                    ...
                    <tr @class(['merah'=> $tabel->tambahsdm_jumlah < $tabel->tambahsdm_terpenuhi, 'biru' =>
                            $tabel->tambahsdm_jumlah == $tabel->tambahsdm_terpenuhi])>
                            <th>
                                <div class="pil-aksi">
                                    <button id="{{'aksi_tsdm_baris_' . $tabels->firstItem() + $nomor}}"
                            ...
                            <td>
                                <a class="isi-xhr taut-akun"
                                    ...
                                    . '.webp'))]) : $urlRangka->asset($mixRangka('/ikon.svg')) . '#akun' }}" alt="{{
                                    $tabel->sdm_nama ??
                            ...
                            <td>
                                <form class="form-xhr" method="POST"
                                    ...
                                    <div class="isian pendek">
                                        ...
                                        <select id="{{'ubah_cepat_status_tsdm_' . $tabels->firstItem() + $nomor}}"
                                        ...
                                        <button type="submit" id="kirim-{{ $tabel->tambahsdm_uuid }}"
                                            sembunyikan></button>
                                    </div>
                                </form>
