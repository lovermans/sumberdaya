...
@section('isi')
    <div id="permintaan_tambah_hapus">
        <form class="form-xhr kartu" id="form_perminTambahSDMHapus" method="POST" action="{{ $app->url->current() }}">
            ...
            <div class="isian gspan-4">
                <p>
                    Yakin menghapus data permintaan tambah SDM : {{ $permin->tambahsdm_no }} -
                    {{ $permin->tambahsdm_penempatan }} - {{ $permin->tambahsdm_posisi }} - {{ $permin->tambahsdm_jumlah }} ?
                </p>
