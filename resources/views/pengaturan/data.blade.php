...
<div id="atur_data">
    ...
    <div class="pintasan tcetak">
        ...
        <a href="#" title="Unduh Data" onclick="event.preventDefault();lemparXHR({tujuan : '#atur_sematan', tautan : window.location.search ? window.location.pathname + window.location.search + '&unduh=excel' : window.location.pathname + '?unduh=excel', strim : true})">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
