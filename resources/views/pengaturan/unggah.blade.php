...
@section('isi')
<div id="atur_unggah">
    <form id="form_atur_unggah" class="form-xhr kartu" method="POST" data-laju="true" data-tujuan="#atur_sematan" action="{{ $urlRangka->route('atur.unggah') }}">
        ...
        <div class="gspan-4">
            ...
            <p>Unduh <a class="isi-xhr" href="{{ $urlRangka->route('atur.contoh-unggah') }}" data-rekam="false" data-tujuan="#atur_sematan" data-laju="true">contoh</a> excel, isi sesuai petunjuk dalam excel lalu unggah kembali.</p>
        </div>
