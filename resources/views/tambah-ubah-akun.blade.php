...
<div id="tambah_ubah_akun">
    <form id="form_tambahUbahAkun" class="form-xhr kartu tcetak" method="POST" action="{{ $urlRangka->current() }}">
        ...
        <div class="isian pendek">
            ...
            $sdm->sdm_no_absen ?? null) . '.webp'))]) : $urlRangka->asset($mixRangka('/ikon.svg')) . '#akun' }}"
            alt="{{ $rekRangka->old('sdm_no_absen', $sdm->sdm_nama ?? 'foto akun') }}" title="{{
            $rekRangka->old('sdm_no_absen', $sdm->sdm_nama ?? 'foto akun') }}" loading="lazy">
        </div>
        ...
        <div class="isian panjang">
            ...
            <select id="permintaan_sdm_no" name="sdm_no_permintaan" class="pil-cari">
                ...
                @if (!in_array($rekRangka->old('sdm_no_permintaan', $sdm->sdm_no_permintaan ?? null), (array)
                $permintaanSdms->pluck('tambahsdm_no')->toArray()) && $rekRangka->old('sdm_no_permintaan',
                $sdm->sdm_no_permintaan ?? null))
                <option value="{{ $rekRangka->old('sdm_no_permintaan', $sdm->sdm_no_permintaan ?? null) }}"
                    class="merah" selected>{{ $rekRangka->old('sdm_no_permintaan', $sdm->sdm_no_permintaan ?? null) }}
                </option>
                @endif

                @foreach ($permintaanSdms as $permintaanSdm)
                <option value="{{ $permintaanSdm->tambahsdm_no }}" @selected($rekRangka->old('sdm_no_permintaan',
        ...
        <div class="isian panjang">
            ...
            <select id="sdm_no_absen_atasan" name="sdm_id_atasan" class="pil-cari">
                ...
                @if (!in_array($rekRangka->old('sdm_id_atasan', $sdm->sdm_id_atasan ?? null), (array)
        ...
        <div class="isian normal">
            ...
            <input id="sdm_no_ktp" type="text" name="sdm_no_ktp"
                value="{{ $rekRangka->old('sdm_no_ktp', $sdm->sdm_no_ktp ?? null) }}" required>
        ...
        <div class="isian panjang">
            ...
            <input id="sdm_nama" type="text" name="sdm_nama"
                value="{{ $rekRangka->old('sdm_nama', $sdm->sdm_nama ?? null) }}" required maxlength="80">
        ...
        <div class="isian normal">
            ...
            <input id="sdm_tempat_lahir" type="text" name="sdm_tempat_lahir"
                value="{{ $rekRangka->old('sdm_tempat_lahir', $sdm->sdm_tempat_lahir ?? null) }}" required
                maxlength="40">
        ...
        <div class="isian pendek">
            ...
            <input id="sdm_tgl_lahir" type="date" name="sdm_tgl_lahir"
                value="{{ $rekRangka->old('sdm_tgl_lahir', $sdm->sdm_tgl_lahir ?? $dateRangka->today()->subYears(18)->toDateString()) }}"
                required>
        ...
        <div class="isian pendek">
            ...
            <select id="sdm_gol_darah" name="sdm_gol_darah" class="pil-saja">
                ...
                @if (!in_array($rekRangka->old('sdm_gol_darah', $sdm->sdm_gol_darah ?? null),
        ...
        <div class="isian panjang">
            ...
            <input id="sdm_alamat" type="text" name="sdm_alamat"
                value="{{ $rekRangka->old('sdm_alamat', $sdm->sdm_alamat ?? null) }}" required maxlength="120">
        ...
        <div class="isian kecil">
            ...
            <input id="sdm_alamat_rt" type="number" name="sdm_alamat_rt" min="0"
                value="{{ $rekRangka->old('sdm_alamat_rt', $sdm->sdm_alamat_rt ?? null) }}">
        ...
        <div class="isian kecil">
            ...
            <input id="sdm_alamat_rw" type="number" name="sdm_alamat_rw" min="0"
                value="{{ $rekRangka->old('sdm_alamat_rw', $sdm->sdm_alamat_rw ?? null) }}">
        ...
        <div class="isian normal">
            ...
            <input id="sdm_alamat_kelurahan" type="text" name="sdm_alamat_kelurahan"
                value="{{ $rekRangka->old('sdm_alamat_kelurahan', $sdm->sdm_alamat_kelurahan ?? null) }}" required
                maxlength="40">
        ...
        <div class="isian normal">
            ...
            <input id="sdm_alamat_kecamatan" type="text" name="sdm_alamat_kecamatan"
                value="{{ $rekRangka->old('sdm_alamat_kecamatan', $sdm->sdm_alamat_kecamatan ?? null) }}" required
                maxlength="40">
        ...
        <div class="isian normal">
            ...
            <input id="sdm_alamat_kota" type="text" name="sdm_alamat_kota"
                value="{{ $rekRangka->old('sdm_alamat_kota', $sdm->sdm_alamat_kota ?? null) }}" required maxlength="40">
        ...
        <div class="isian normal">
            ...
            <input id="sdm_alamat_provinsi" type="text" name="sdm_alamat_provinsi"
                value="{{ $rekRangka->old('sdm_alamat_provinsi', $sdm->sdm_alamat_provinsi ?? null) }}" required
                maxlength="40">
        ...
        <div class="isian pendek">
            ...
            <input id="sdm_alamat_kodepos" type="text" name="sdm_alamat_kodepos"
                value="{{ $rekRangka->old('sdm_alamat_kodepos', $sdm->sdm_alamat_kodepos ?? null) }}" maxlength="10">
        ...
        <div class="isian normal">
            ...
            <input id="sdm_no_kk" type="text" name="sdm_no_kk"
                value="{{ $rekRangka->old('sdm_no_kk', $sdm->sdm_no_kk ?? null) }}">
        ...
        <div class="isian normal">
            ...
            <select id="sdm_status_kawin" name="sdm_status_kawin" class="pil-cari" required>
                @if (!in_array($rekRangka->old('sdm_status_kawin', $sdm->sdm_status_kawin ?? null),
        ...
        <div class="isian pendek">
            ...
            <input id="sdm_jml_anak" type="number" name="sdm_jml_anak" min="0"
                value="{{ $rekRangka->old('sdm_jml_anak', $sdm->sdm_jml_anak ?? null) }}">
        ...
        <div class="isian normal">
            ...
            <select id="sdm_pendidikan" name="sdm_pendidikan" class="pil-cari" required>
                ...
                @if (!in_array($rekRangka->old('sdm_pendidikan', $sdm->sdm_pendidikan ?? null),
        ...
        <div class="isian normal">
            ...
            <input id="sdm_jurusan" type="text" name="sdm_jurusan"
                value="{{ $rekRangka->old('sdm_jurusan', $sdm->sdm_jurusan ?? null) }}" maxlength="60">
        ...
        <div class="isian normal">
            ...
            <input id="sdm_telepon" type="tel" name="sdm_telepon"
                value="{{ $rekRangka->old('sdm_telepon', $sdm->sdm_telepon ?? null) }}" maxlength="40" inputmode="tel"
                required>
        ...
        <div class="isian normal">
            ...
            <input id="email" type="email" name="email" value="{{ $rekRangka->old('email', $sdm->email ?? null) }}"
        ...
        <div class="isian normal">
            ...
            <input id="sdm_no_bpjs" type="text" name="sdm_no_bpjs"
                value="{{ $rekRangka->old('sdm_no_bpjs', $sdm->sdm_no_bpjs ?? null) }}" maxlength="30">
        ...
        <div class="isian normal">
            ...
            <input id="sdm_no_jamsostek" type="text" name="sdm_no_jamsostek"
                value="{{ $rekRangka->old('sdm_no_jamsostek', $sdm->sdm_no_jamsostek ?? null) }}" maxlength="30">
        ...
        <div class="isian normal">
            ...
            <input id="sdm_no_npwp" type="text" name="sdm_no_npwp"
                value="{{ $rekRangka->old('sdm_no_npwp', $sdm->sdm_no_npwp ?? null) }}" maxlength="30">
        ...
        <div class="isian pendek">
            ...
            <select id="sdm_nama_bank" name="sdm_nama_bank" class="pil-cari">
                ...
                @if (!in_array($rekRangka->old('sdm_nama_bank', $sdm->sdm_nama_bank ?? null),
        ...
        <div class="isian normal">
            ...
            <input id="sdm_cabang_bank" type="text" name="sdm_cabang_bank"
                value="{{ $rekRangka->old('sdm_cabang_bank', $sdm->sdm_cabang_bank ?? null) }}" maxlength="50">
        ...
        <div class="isian normal">
            ...
            <input id="sdm_rek_bank" type="text" name="sdm_rek_bank"
                value="{{ $rekRangka->old('sdm_rek_bank', $sdm->sdm_rek_bank ?? null) }}" maxlength="40">
        ...
        <div class="isian panjang">
            ...
            <input id="sdm_an_rek" type="text" name="sdm_an_rek"
                value="{{ $rekRangka->old('sdm_an_rek', $sdm->sdm_an_rek ?? null) }}" maxlength="80">
        ...
        <div class="isian panjang">
            ...
            <input id="sdm_nama_dok" type="text" name="sdm_nama_dok"
                value="{{ $rekRangka->old('sdm_nama_dok', $sdm->sdm_nama_dok ?? null) }}" maxlength="50">
        ...
        <div class="isian normal">
            ...
            <input id="sdm_nomor_dok" type="text" name="sdm_nomor_dok"
                value="{{ $rekRangka->old('sdm_nomor_dok', $sdm->sdm_nomor_dok ?? null) }}" maxlength="40">
        ...
        <div class="isian panjang">
            ...
            <input id="sdm_penerbit_dok" type="text" name="sdm_penerbit_dok"
                value="{{ $rekRangka->old('sdm_penerbit_dok', $sdm->sdm_penerbit_dok ?? null) }}" maxlength="60">
        ...
        <div class="isian panjang">
            ...
            <input id="sdm_an_dok" type="text" name="sdm_an_dok"
                value="{{ $rekRangka->old('sdm_an_dok', $sdm->sdm_an_dok ?? null) }}" maxlength="80">
        ...
        <div class="isian pendek">
            ...
            <input id="sdm_kadaluarsa_dok" type="date" name="sdm_kadaluarsa_dok"
                value="{{ $rekRangka->old('sdm_kadaluarsa_dok', $sdm->sdm_kadaluarsa_dok ?? null) }}">
        ...
        <div class="isian pendek">
            ...
            <select id="sdm_uk_seragam" name="sdm_uk_seragam" class="pil-cari">
                ...
                @if (!in_array($rekRangka->old('sdm_uk_seragam', $sdm->sdm_uk_seragam ?? null),
        ...
        <div class="isian pendek">
            ...
            <input id="sdm_uk_sepatu" type="number" name="sdm_uk_sepatu" min="0"
                value="{{ $rekRangka->old('sdm_uk_sepatu', $sdm->sdm_uk_sepatu ?? null) }}">
        ...
        <div class="isian pendek">
            ...
            <input id="sdm_tgl_berhenti" type="date" name="sdm_tgl_berhenti"
                value="{{ $rekRangka->old('sdm_tgl_berhenti', $sdm->sdm_tgl_berhenti ?? null) }}">
        ...
        <div class="isian normal">
            ...
            <select id="sdm_jenis_berhenti" name="sdm_jenis_berhenti" class="pil-cari">
                ...
                @if (!in_array($rekRangka->old('sdm_jenis_berhenti', $sdm->sdm_jenis_berhenti ?? null),
        ...
        <a class="sekunder isi-xhr" href="{{ $urlRangka->route('sdm.akun', ['uuid' => $sdm->sdm_uuid]) }}">TUTUP</a>
        @else
        <a class="sekunder isi-xhr"
            href="{{ $urlRangka->to($rekRangka->session()->get('tautan_perujuk') ?? '/') }}">TUTUP</a>
        @endif
